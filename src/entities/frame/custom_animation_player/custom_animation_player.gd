...
var _animation_player_running: bool = false
var _tween_player_running: bool = false
...
func _animation_component_started(signal_origin: String) -> void:
    match signal_origin:
        "animation":
            _animation_player_running = true
        "tween":
            _tween_player_running = true


func _animation_component_finished(signal_origin: String) -> void:
    match signal_origin:
        "animation":
            _animation_player_running = false
        "tween":
            _tween_player_running = false
    if not _animation_player_running and not _tween_player_running:
